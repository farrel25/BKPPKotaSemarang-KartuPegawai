...
<section id="team" class="team section-bg">
    <div class="container">
        <div class="section-title" data-aos="fade-up">
            <h2>Anggota</h2>
            <p>Angota dalam pengembangan Website Kartu Pegawai BKPP</p>
        </div>
        <div class="row justify-content-center">
            <div class="col-lg-3 col-md-6 d-flex align-items-stretch">
                <div class="member m-auto" data-aos="fade-up" data-aos-delay="100">
                    <div class="member-img">
                        <img src="{{ asset('/visitor/images') }}/team-1.jpg" class="img-fluid" alt="">
                        <div class="social">
                    ...
                    <div class="member-info">
                        <h4>Maylinda Putri Ardiani</h4>
                        <span>A11.2018.11480</span>
                    </div>
                </div>
            </div>
            <div class="col-lg-3 col-md-6 d-flex align-items-stretch">
                <div class="member m-auto" data-aos="fade-up" data-aos-delay="200">
                    <div class="member-img">
                        <img src="{{ asset('/visitor/images') }}/team-2.jpg" class="img-fluid" alt="">
                        <div class="social">
                            <a href=""><i class="icofont-twitter"></i></a>
                            <a href=""><i class="icofont-facebook"></i></a>
                            <a href=""><i class="icofont-instagram"></i></a>
            ...
            <div class="col-lg-3 col-md-6 d-flex align-items-stretch">
                <div class="member m-auto" data-aos="fade-up" data-aos-delay="300">
                    <div class="member-img">
                        <img src="{{ asset('/visitor/images') }}/team-3.jpg" class="img-fluid" alt="">
                        <div class="social">
                            <a href=""><i class="icofont-twitter"></i></a>
                            <a href=""><i class="icofont-facebook"></i></a>
                            <a href=""><i class="icofont-instagram"></i></a>
                    ...
                    <div class="member-info">
                        <h4>Diaz Astiza Riftiya</h4>
                        <span>A11.2018.11248</span>
                    </div>
                </div>
            </div>
            <div class="col-lg-3 col-md-6 d-flex align-items-stretch">
                <div class="member m-auto" data-aos="fade-up" data-aos-delay="400">
                    <div class="member-img">
                        <img src="{{ asset('/visitor/images') }}/team-4.jpg" class="img-fluid" alt="">
                        <div class="social">
                            <a href=""><i class="icofont-twitter"></i></a>
                            <a href=""><i class="icofont-facebook"></i></a>
                            <a href=""><i class="icofont-instagram"></i></a>
                    ...
                    <div class="member-info">
                        <h4>Hafianto Febriko Hidayat</h4>
                        <span>A11.2018.11259</span>
                    </div>
                </div>
            </div>
        </div>
